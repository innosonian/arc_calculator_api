...
while IFS=$'\t' read -r key value; do
  case "${key}" in
    ...
    LAMBDA_ROLE_NAME|ARC_LAMBDA_MEMORY_MB|ARC_LAMBDA_TIMEOUT_SEC|ARC_LOG_RETENTION_DAYS|ARC_LAMBDA_RESERVED_CONCURRENCY|ARC_STORAGE_BUCKET|ARC_STORAGE_PREFIX) ;;
